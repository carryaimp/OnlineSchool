...
$(function(){
    ...
    $('#jsResetPwdBtn').click(function(){
        $.ajax({
            ...
            type: "POST",
            dataType:'json',
            url:"/center/update-pwd/",
            data:$('#jsResetPwdForm').serialize(),
            async: true,
            success: function(data) {
                if(data.first_password){
                    Dml.fun.showValidateError($("#pwd"), data.first_password);
                }else if(data.sure_password){
                    Dml.fun.showValidateError($("#repwd"), data.sure_password);
                }else if(data.status == "success"){
